"use strict";var S=Object.defineProperty;var A=Object.getOwnPropertyDescriptor;var J=Object.getOwnPropertyNames;var U=Object.prototype.hasOwnProperty;var X=(t,e)=>{for(var r in e)S(t,r,{get:e[r],enumerable:!0})},H=(t,e,r,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of J(e))!U.call(t,s)&&s!==r&&S(t,s,{get:()=>e[s],enumerable:!(n=A(e,s))||n.enumerable});return t};var z=t=>H(S({},"__esModule",{value:!0}),t);var tt={};X(tt,{Box:()=>_,Button:()=>v,Flex:()=>P,Grid:()=>M,Text:()=>T});module.exports=z(tt);var R=require("react/jsx-runtime"),K=()=>(0,R.jsx)("div",{className:`
      ...
      `,disabled:l||f,onClick:Q,children:(0,b.jsxs)(V,{as:t,href:n,target:s?"_blank":"_self",children:[a,(0,b.jsxs)("span",{className:"button-8us4IE__link",children:[L,N&&(0,b.jsx)("span",{className:"button-8us4IE__link__hint",children:N})]}),p,l&&(0,b.jsx)(k,{})]})})},V=({as:t,href:e,target:r,children:n})=>{let s=t;if(t&&!e||!t&&e)throw new Error("Please provide both - as and href props");return e?(0,b.jsx)(s,{href:e,target:r,children:n}):(0,b.jsx)("div",{children:n})},v=O;var E=require("react");function g(t){let[e,r]=(0,E.useState)(!1);return(0,E.useEffect)(()=>{let n=window.matchMedia(`(min-width: ${t}px)`);n.matches!==e&&r(n.matches);let s=()=>{r(n.matches)};return n.addEventListener("change",s),()=>n.removeEventListener("change",s)},[e,t]),e}var D=require("react/jsx-runtime"),Y=({children:t,display:e="flex",alignItems:r,justifyContent:n,flexDirection:s="row",wrap:o,columnGap:i,rowGap:u,fullHeight:d,fullWidth:h,className:x="",spacing:l,center:f,onClick:a})=>{let p=g(1168),y={};return i&&(y.columnGap=c(i,p)),u&&(y.rowGap=c(u,p)),l&&(y.marginBottom=c(l,p)),(0,D.jsx)("div",{className:`
        ...
        ${x}
      `,style:y,onClick:()=>{a&&a()},role:a?"button":"",children:t})},P=Y;var F=require("react/jsx-runtime"),Z=({children:t,backgroundColor:e="",padding:r,borderRadius:n,borderWidth:s,border:o="",opacity:i=100,shadow:u,overflow:d="visible",className:h="",spacing:x,onClick:l})=>{let f=g(1168),a={overflow:d};return r&&(a.padding=w(r,f)),n&&(a.borderRadius=w(n,f)),x&&(a.marginBottom=c(x,f)),s&&(a.borderWidth=m(s)),(0,F.jsx)("div",{className:`
        box-8us4IE 
        ${e?`box-8us4IE-backgroundColor-${e}-${i}`:""}
        ${o?`box-8us4IE-border-${o}`:""}
        ${u?`box-8us4IE-shadow-${u}`:""}
        ${h}
      `,style:a,onClick:()=>{l&&l()},role:l?"button":"",children:t})},_=Z;var G=require("react/jsx-runtime"),j=({tagName:t,mobile:e=!1,transform:r,decoration:n,fontWeight:s,variant:o,color:i,className:u="",align:d,spacing:h,fontFamily:x,children:l})=>{let f=g(1168),a=t,p={};return h&&(p.marginBottom=c(h,f)),s&&(p.fontWeight=s.toString()),(0,G.jsx)(a,{style:p,className:`
        text-8us4IE
        ...
        ${u}
      `,children:l})},T=j;var W=require("react/jsx-runtime"),q=({children:t,column:e,gutter:r,className:n="",spacing:s})=>{let o=g(1168),i={};return s&&(i.marginBottom=c(s,o)),(0,W.jsx)("div",{className:`
        grid-8us4IE
        grid-8us4IE-${C(e,o)}-${C(r,o)}
        ${n}
      `,style:i,children:t})},M=q;0&&(module.exports={Box,Button,Flex,Grid,Text});
